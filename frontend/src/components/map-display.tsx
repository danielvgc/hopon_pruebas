    ...
    <div className="relative w-full rounded-lg border border-neutral-700 overflow-hidden">
      ...
      {userLocation && (
        <button
          ...
          className="absolute top-16 right-12 bg-white hover:bg-neutral-100 text-neutral-900 rounded-full p-2 sm:p-3 shadow-lg z-20 transition flex items-center justify-center"
